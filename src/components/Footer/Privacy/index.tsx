            ...
            <Box py={5}>
                <Box>
                    <Typography variant="h1">
                        Let'doretro Privacy policy
                    </Typography>
                    <Box mt={3}>
                        <Typography component="p" variant="body1">
                        Thank you for visiting/using Let's do retro. In order to protect your privacy we provide this notice explaining our best practices. This privacy policy applies between you, the User of this Website and Let's do retro App, the owner and provider of this Website.
                        </Typography>
                    </Box>
                    <Box mt={3}>
                    ...
                    <Box mt={5}>
                        ...
                        <Box mt={2}>
                            <Typography variant="body1">
                                Letsdoretro App will collect your Data in a number of ways, for example:
                            </Typography>
                            <FAQList list={[
                                "Orgnization details such as name and description of the organization", 
                    ...
                    <Box mt={5}>
                        ...
                        <Box mt={2}>
                            <Typography variant="body1">
                            Let's do retro App reserves the right to change this privacy policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Website and you are deemed to have accepted the terms of the privacy policy on your first use of the Website following the alterations.You may contact Let's do retro App by email at contact@letsdoretro.com.
                            </Typography>
                        </Box>
                    </Box>
                </Box>
