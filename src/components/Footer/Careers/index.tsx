    ...
    return (
      <React.Fragment>
        <Container fixed disableGutters>
          ...
          <Box my={3}>
            <Typography variant="body2">Help us build a social platform that helps our society.</Typography>
          </Box>
          <Box>
            <Typography variant="h2">Working Here</Typography>
          </Box>
          <Box my={3}>
            <Typography variant="body2">Billions of people rely on writenpost to post information about
          ...
          <Box my={3}>
            <Typography variant="body2">Sorry! We do not have open positions now. Please come back and check.</Typography>
          </Box>
          <Features />
        </Container>
      </React.Fragment>
