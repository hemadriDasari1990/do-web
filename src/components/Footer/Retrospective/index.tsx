      ...
      <Container>
          ...
          <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
            ...
            <Box mb={3}>
              <Typography component="p">
                ...
                collective time in meetings, I understand if you’re hesitant to
                pull your team together for yet another sit-down. However, agile
                retrospectives are well worth the time and effort. Here’s why:
              </Typography>
            </Box>
            <Box mb={2}>
          ...
          <Grid item xl={7} lg={7} md={7} sm={6} xs={12}>
            <GridItem
              item={{
                step: "#",
                index: 1,
                title: `That brings us to the biggest benefit of retrospectives. When your agile team takes advantage of these regular intervals to evaluate their collaborations, their processes and output get better and better.`,
              }}
            />
          </Grid>
          <Grid item xl={5} lg={5} md={5} sm={6} xs={12}>
            <GridItem
              item={{
                step: "#",
                index: 2,
                title: `They’ll continue to identify areas for improvement and then actually act on them. The result? An unstoppable team.`,
              }}
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
            ...
            <Box mb={3}>
              <Typography component="p">
                Now that you’re armed with the questions you want to ask, you’re
                ready to pull your retrospective meeting together. Here are six
          ...
          <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
            ...
            <Box mb={3}>
              <Typography component="p">
                ...
                rolling. But, keep your eye out for a few common roadblocks that
                could throw your retrospective meeting off track.
              </Typography>
            </Box>
          </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
            ...
            <Box mb={3}>
              <Typography component="p">
                So, you’ve reached the end of the sprint and are planning to do
                a retrospective. If you’re expecting your team to roll up their
                sleeves and start picking apart their own collaborations, you’re
            ...
            <Box mb={3}>
              <Typography component="p">
                ...
                want to come prepared with some questions to get the discussion
                rolling. Here are four questions your team should be sure to
                address.
              </Typography>
            </Box>
          </Grid>
