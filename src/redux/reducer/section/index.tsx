import {
    ...
    CREATE_SECTION_INTERNAL_SERVER_ERROR,
...
const section = (state = initialState, action: ReduxAction) => {
    switch(action.type){
        ...
        case CREATE_SECTION_INTERNAL_SERVER_ERROR:
            return {
                ...state,
                response: action.payload,
                loading: false
        ...
        case DELETE_SECTION_INTERNAL_SERVER_ERROR:
            return {
                ...state,
                response: action.payload,
                loading: false
        ...
        case GET_SECTIONS_BY_BOARD_INTERNAL_SERVER_ERROR:
            return {
                ...state,
                response: action.payload,
                loading: false
        ...
        case UPDATE_SECTION_INTERNAL_SERVER_ERROR:
            return {
                ...state,
                response: action.payload,
                loading: false
