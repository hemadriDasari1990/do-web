...
export const CREATE_INSTANT_BOARD_REQUEST = "CREATE_INSTANT_BOARD_REQUEST";
export const CREATE_INSTANT_BOARD_SUCCESS = "CREATE_INSTANT_BOARD_SUCCESS";
export const CREATE_INSTANT_BOARD_FAILED = "CREATE_INSTANT_BOARD_FAILED";
